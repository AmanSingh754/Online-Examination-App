...
async function gradeDescriptiveAnswerDetailed(reference, studentAnswer, maxMarks = 1, options = {}) {
    ...
    const prompt = [
        ...
        "- Interns Test (foundational programming, web, database, aptitude, and coding-readiness concepts)",
        "",
        ...
        "- For Interns Test: validate foundational technical understanding, programming logic, web/database basics, and coding-readiness clarity.",
...
async function generateWalkinPerformanceSummary(student, rows = []) {
    ...
    const prompt = [
        ...
        "For Interns Test stream, relevant skill topics include foundational programming, web basics, database basics, problem solving, aptitude, debugging, and coding implementation.",
